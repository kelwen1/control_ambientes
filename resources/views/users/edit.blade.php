    ...
    <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8">
        <form method="POST" action="{{ route('users.update', $user->id_cedula) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div>
                    <label for="password_actual" class="block text-sm sm:text-base font-semibold text-gray-700 mb-2">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword('password_actual', this)" class="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 text-gray-500 hover:text-gray-700 focus:outline-none" tabindex="-1" aria-label="Mostrar contraseña">
